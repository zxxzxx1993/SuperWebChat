...
public class NewGroupActivity extends BaseActivity {
    ...
    public void save(View v) {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            startActivityForResult(new Intent(this, GroupPickContactsActivity.class).putExtra("groupName", name), REQUESTCODE_PICK_MEMERY);
        }
    }
...
//                    updateAppUserAvatar(data);
    ...
    @OnClick(R.id.layout_avatar_send)
    public void onClick() {
        uploadHeadPhoto();
    }
    ...
    private void setPicToView(Intent picdata) {
        ...
        if (extras != null) {
            ...
            ivGroup.setImageDrawable(drawable);
